...
local function GeneratePlayerSpellList()
    ...
    while true do
        ...
        print('spelldetect',spellName,valueMin,spellValueMax,isHeal,duration)
    ...
    print(stringifyTable(spellList))
    return spellList
end
...
function pickBestAction(metrics)
    ...
    for _, candidate in pairs(candidates) do
        ...
        print("considering",unit,spell.name,unitMissingHealth,efficiency,precision )
...
endlocal function GetSpellValueFromTooltip(spellID)
    if not spellID then
        return nil, nil, nil, nil, nil
    end
